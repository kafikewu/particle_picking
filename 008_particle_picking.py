...
import json
import numpy as N
os.chdir("../results/pp_None_2") # Depends on your current dir
...
def main():
    ...
    path = '/shared/home/v_kafi_khan/tomotarget0.mrc'
    ...
    print(mrc_header['MRC']['xlen'])
    voxel_spacing_in_nm = 13728.66015625/ 1023 / 10
